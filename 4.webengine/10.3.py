...
class GraphicsView(QGraphicsView):
    def __init__(self, parent=None):
        ...
        self.zoom_out_limit = 1  # Set the zoom out limit to the image size
    ...
    def wheelEvent(self, event):
        ...
        if event.angleDelta().y() > 0:
            ...
            # Do not zoom out if the image size is the original size
            if self.transform().m11() > self.zoom_out_limit:
...
slider.setRange(1, 640)  # Set the range of the slider to the width of the image
slider.setMinimum(1)
